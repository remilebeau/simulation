  ...
  return (
    <section className="flex flex-col gap-4 p-4">
      ...
      <p>
        ...
        This is calculated by counting the number of simulations that resulted
        in a negative profit and dividing that number by the total number of
        simulations, which in our case is 1000. For example, if 200 profit
        values were below 0, then the probability of losing money is
        approximately 20%. From this point estimate, we can also calculate a 95%
        confidence interval.
      </p>
      <p>
